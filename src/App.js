    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <Main open={open}>
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh', flexDirection: 'column' }}>
          ...
          <Typography variant="h2" color="inherit" noWrap style={{ marginBottom: '16px', textAlign: 'center', fontFamily: 'Arial, sans-serif', fontWeight: 'bold', fontSize: '40px', color: '#1D419F' }}>
            La voie vers l'insertion professionnelle
          </Typography>
